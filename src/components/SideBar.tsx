  ...
  return (
    <>
      ...
      <div
        ...
        } flex-col justify-between items-center shadow-lg`}
      >
        <NavLink to={"/"} onClick={() => setSelectedIcon("Home")}>
          <img src="../src/assets/logo.svg" alt="logo" className="w-12" />
        </NavLink>
        ...
        <button
          className="sidebar-icons rounded-3xl text-blue-500 bg-gray-800 hover:bg-blue-600 hover:text-white hover:rounded-xl"
